...
def action_scoring(video, c3d_alt_path, fc6_path, score_reg_path):
    ...
    # new_cfa = tf.reduce_mean(clip_feats_avg, axis=[1, 2, 3])
...
def main():
    ...
    for index, frames in enumerate(valid_array):
...
def save_results(classifications, scores):
    ...
    # sum from model is total loss from action classifier and action scorer
    # action scorer gives top five
